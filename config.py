...
class Config:
    ...
    FLASKY_MAIL_SENDER  = 'flasky Admin<benkaimugul@gmail.com>'
...
class ProductionConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DEV_DATABSE_URL') or 'sqlite:///' +os.path.join(basedir, 'data.sqlite')
